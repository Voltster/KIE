...
const WalletCard = ({ icon, heading, para }) => {
  return (
    <div
      className="card w-full md:w-[40vw] wallet cursor-pointer rounded-lg p-2 bg-blue-100 rounded-tr-lg overflow-hidden flex flex-col justify-center items-center relative shadow-md transition-all duration-300 ease-out"
    ...
    >
      ...
      <h3 className="text-2xl font-semibold text-center relative z-20 mt-4">
        {heading}
      </h3>
