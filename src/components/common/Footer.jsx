          ...
          >
            <div className="mx-auto max-w-sm lg:max-w-none">
              <p className="mt-4 text-center text-gray-100 lg:text-left lg:text-lg">
                ...
                services, browse our gallery, or contact us for a free
            ...
            <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
              <div>
                ...
                <ul className="mt-6 space-y-1">
                  ...
                  <li className="text-gray-100 transition hover:text-gray-100/75">
                    <Link to={"/service"}>Merchandise</Link>
                  </li>
                  <li className="text-gray-100 transition hover:text-gray-100/75">
                    <Link to={"/service"}>Label and Tag </Link>
                  </li>
                  <li className="text-gray-100 transition hover:text-gray-100/75">
                    <Link to={"/service"}>Offset Printing </Link>
                  </li>
                </ul>
              </div>
